...
function Contact() {
  return (
    <div className="contact row col-10 mx-auto rounded">
      <div className="col-sm-10 col-md-4 my-auto text-center">
        <h1>
          Start a{" "}
          <span
            style={{ fontFamily: "'Italiana', sans-serif", fontWeight: 900 }}
          >
            project
          </span>
        </h1>
      ...
      <div className="col-sm-10 col-md-4 my-auto text-center">
        <a
          target="_blank"
          className="DO"
          href="https://wa.me/8307366873?text=Hey%20I%20want%20a%20website"
        >
          <span className="icon">
            <svg
              className="svg-inline--fa fa-hand-horns"
              aria-hidden="true"
              focusable="false"
              data-prefix="far"
