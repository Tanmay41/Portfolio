  ...
  return (
    <html className={"overflow-x-hidden"} lang="en">
      <head>
        ...
        <meta property="og:url" content="https://tanmayportfolio.vercel.app" />
        ...
        <meta property="twitter:domain" content="tanmayportfolio.vercel.app" />
        <meta
        ...
        <link
          href="https://api.fontshare.com/v2/css?f[]=dancing-script@400&f[]=pencerio@50&display=swap"
          rel="stylesheet"
        />
      </head>
      <body
